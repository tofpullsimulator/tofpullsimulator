...
@SpringBootTest(classes = {CreateWeaponCommand.class, BannerService.class})
@ComponentScan(basePackages = {"org.eos.tof.common"})
@EnableAutoConfiguration
class CreateWeaponCommandTest {

    @Autowired
    private CreateWeaponCommand command;
    @Autowired
    ...
    void shouldGetTheNameOfTheCommand() {
        Assertions.assertEquals("banner create-weapon", command.getName());
    }
